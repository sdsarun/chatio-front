...
export default function ChatInput({ rootClassName, disabled, onSubmit }: ChatInputProps) {
  ...
  return (
    <div className={cn("flex-1 flex flex-col bg-accent my-2 rounded-lg", rootClassName)}>
      <Form {...formChatInput}>
        <form
          onSubmit={formChatInput.handleSubmit(handleChatInputSubmit)}
            ...
            render={({ field }) => (
              <FormItem className="flex-1 relative">
                ...
                <Button
                  ...
                  size="icon"
                  type="submit"
                  disabled={disabled || field?.value?.length === 0}
                >
                  <Send />
                </Button>
              </FormItem>
